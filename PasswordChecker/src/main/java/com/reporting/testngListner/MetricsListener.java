package com.reporting.testngListner;
...
import com.reporting.exception.ReportConfigException;
import com.reporting.utils.HtmlBuilder;
import com.reporting.utils.Utils;
import com.reporting.utils.Utils.ExecutionResults;
...
public class MetricsListener implements IReporter, ITestListener {
	  ...
	  public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
	    ...
	    String logo =
	        System.getProperty("testng.metrics.logo", "https://cdn6.agoda.net/images/MVC/default/agoda-logo.svg");
